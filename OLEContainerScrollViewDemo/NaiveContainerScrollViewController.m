...
@property (nonatomic) SimulatedTableView *tableView1;
@property (nonatomic) SimulatedTableView *tableView2;
...
- (void)viewDidLoad
{
    ...
    self.tableView1 = [[SimulatedTableView alloc] initWithNumberOfRows:9 rowHeight:72 edgeInsets:UIEdgeInsetsMake(16, 16, 16, 16) cellSpacing:4];
    ...
    self.tableView2 = [[SimulatedTableView alloc] initWithNumberOfRows:12 rowHeight:48 edgeInsets:UIEdgeInsetsMake(16, 16, 16, 16) cellSpacing:4];
